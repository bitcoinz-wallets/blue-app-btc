...
# BitcoinZ
DEFINES   += BTCHIP_P2PKH_VERSION=7352 BTCHIP_P2SH_VERSION=7357 BTCHIP_COIN_FAMILY=1 BTCHIP_COINID=\"BitcoinZ\" COINID_UPCASE=\"BITCOINZ\" COLOR_HDR=0x3790CA COLOR_DB=0x9BC8E5 COINID_NAME=\"BitcoinZ\" COINID=$(COIN) BTCHIP_COINID_SHORT=\"BTCZ\" COIN_BITCOINZ
APPNAME ="BitcoinZ"
APP_LOAD_PARAMS += --path $(APP_PATH)
...
$(error Unsupported COIN - use bitcoin_testnet, bitcoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, bitcoinz, komodo, stratis, peercoin, posw, pivx, viacoin, vertcoin, stealthcoin, digibyte, qtum, hcash)
endif
endif
